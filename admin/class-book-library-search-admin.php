 ...
 * @subpackage Book_Library_Search/admin
 */
 ...
 */
class Book_Library_Search_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/book-library-search-admin.css', array(), $this->version, 'all' );
